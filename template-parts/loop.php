      ...
      <div class="flex flex-col bg-white border rounded-lg overflow-hidden">
        <a href="<?php the_permalink(); ?>" class="group h-48 md:h-48 block bg-gray-100 overflow-hidden relative">
          <?php if ( has_post_thumbnail() ) : ?>
            ...
            <?php else: ?>
              <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/contact00.jpg" loading="lazy" alt="" class="w-full h-full object-cover object-center absolute inset-0 group-hover:scale-110 transition duration-200" />
        <?php endif; ?>
        </a>
