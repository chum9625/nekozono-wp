              ...
              <div class="navbar-start">
                <div class="dropdown">
                  ...
                  <ul tabindex="0" class="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
                    ...
                    <li><a href="https://cms.chum9625.com/nya-00/#price">料金表</a></li>
                    <li tabindex="0">
                      <a class="justify-between">
                      店舗について
                      <svg class="fill-current" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                    ...
                    <ul class="p-2 bg-slate-50">
                      <li><a href="https://cms.chum9625.com/nya-00/vision.html">ビジョン</a></li>
                      <li><a href="https://cms.chum9625.com/nya-00/notes.html">ご利用規約</a></li>
                      <li><a href="https://cms.chum9625.com/nya-00/lental.html">レンタルスペース</a></li>
                      <li><a href="https://cms.chum9625.com/nya-00/#shopinfo">基本情報</li>
                      </ul>
                    </li>
                  </ul>
                </div>
              ...
              <div class="navbar-center hidden lg:flex">
                <ul class="menu menu-horizontal p-0">
                  <li tabindex="0">
                    ...
                    <ul class="p-2 bg-slate-50">
                      <li><a href="<?php echo home_url(); ?>">お知らせ</a></li>
                      <li><a href="<?php echo get_the_category()[1]->slug; ?>">にゃんず</a></li>
                      <li><a href="https://cms.chum9625.com/nya-00/#schedule">スケジュール</a></li>
                    </ul>
                  </li>
